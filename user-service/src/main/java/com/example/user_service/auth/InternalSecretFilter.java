 ...
 * agreed X-Internal-Secret. Requests outside /internal/** are ignored. Wired into
 * the security chain by {@code SecurityConfig} (constructor-injected secret), so
 * it is deliberately NOT a @Component (avoids double registration).
 */
public class InternalSecretFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        // Only the internal API is protected by this filter.
